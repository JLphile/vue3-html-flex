...
<html lang="en">
  ...
  <!-- 2.link引入 -->
  <link rel="stylesheet" href="../src/assets/css/css-basic.css">
  <body>
    <!-- 3.内联样式 -->
    <div style="color: red">css引入</div>
  </body>
</html>
...
**注意：**内联样式权重最高，内部样式表和link引入权重等价，后面后覆盖前面的样式。
...
<style>
  ...
  <body>
    <div>我是class="box"的div标签</div>
    <p>我是class="box"的p标签</p>
  </body>
```
...
1. ：first-child
   ...
   ：first-child伪类与指定的元素匹配：该元素是另一个元素的第一个子元素
2. :
